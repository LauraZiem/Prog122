...
public class Exercicio01 {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Valor monetário: " + dinheiro.format(d));
            System.out.printf("%s\n", valorPorExtenso(d));
        }
        catch(NumberFormatException ex){
            System.out.println("Valor informaddo não é válido!");
        }
    ...
    public static String valorPorExtenso(double d) {
        ...
        long inteiro = (long)Math.abs(d); // parte inteira do valor
        double resto = d - inteiro;       // parte fracionária do valor
